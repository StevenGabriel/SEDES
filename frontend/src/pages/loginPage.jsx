...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col lg:flex-row bg-[#f8fafc] font-sans antialiased text-slate-800 select-none sm:select-text">
      ...
      {/* ========================================================================= */}
      <section className="lg:w-1/2 flex items-center justify-center p-4 sm:p-6 md:p-8 lg:p-10 xl:p-12 min-h-[460px] sm:min-h-[500px] flex-1">
        <div className="w-full max-w-[440px] bg-white rounded-2xl sm:rounded-3xl p-5 sm:p-8 lg:p-10 shadow-lg sm:shadow-[0_20px_50px_rgba(0,35,70,0.08)] border border-slate-100/80 transition-all duration-300">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3.5 py-2.5 sm:py-2.5 rounded-xl border border-slate-200 text-slate-800 placeholder-slate-400 text-base sm:text-sm focus:outline-none focus:ring-2 focus:ring-[#0073c6]/20 focus:border-[#0073c6] transition-all bg-white hover:border-slate-300"
              />
            </div>
            ...
            <div>
              ...
              <div className="relative flex items-center">
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full px-3.5 py-2.5 sm:py-2.5 pr-11 rounded-xl border border-slate-200 text-slate-800 placeholder-slate-400 text-base sm:text-sm focus:outline-none focus:ring-2 focus:ring-[#0073c6]/20 focus:border-[#0073c6] transition-all bg-white hover:border-slate-300"
                />
                <button
                  type="button"
            ...
            <div className="flex flex-wrap items-center justify-between gap-2 pt-1 text-xs sm:text-sm">
              <label className="flex items-center space-x-2 cursor-pointer select-none group py-1">
                <div className="relative flex items-center">
                  <input
                    type="checkbox"
                    checked={rememberMe}
              ...
              <Link
                ...
                className="text-[#0073c6] hover:text-[#005596] font-medium text-xs sm:text-sm hover:underline transition-colors cursor-pointer py-1"
              >
